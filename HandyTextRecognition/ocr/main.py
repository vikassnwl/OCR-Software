...
class FilePaths:
    ...
    # fn_char_list = '/home/rohit/Desktop/OCR_SHTR/SimpleHTR/model/charList.txt'
    # fn_summary = '/home/rohit/Desktop/OCR_SHTR/SimpleHTR/model/summary.json'
    # fn_corpus = '/home/rohit/Desktop/OCR_SHTR/SimpleHTR/data/corpus.txt'

    fn_char_list = 'ocr/model/charList.txt'
    fn_summary = 'ocr/model/summary.json'
    fn_corpus = 'ocr/data/corpus.txt'

import os
print(os.getcwd())
if os.path.exists("../model/charList.txt"):
    print('yes')
else:
    print('no')
...
def main(img_file):
    ...
    parser.add_argument('--img_file', help='Image used for inference.', type=Path, default=img_file)
    ...
    # infer text on test image
        ...
        data = infer(model, args.img_file)
        return data
# main()